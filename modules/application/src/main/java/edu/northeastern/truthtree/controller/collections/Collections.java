...
public class Collections implements ICollections {
  ...
  /**
   * Represents collections interface. With an optional query parameter of locationId, user can
   * search for all the collections in the TruthTree Application. If user provides locationId,
   * additionally, this api would filter out collections relevant to that location.
   *
   * @param locationId which represents unique identifier for a location.
   * @author nehashukla
   */
  @Override
