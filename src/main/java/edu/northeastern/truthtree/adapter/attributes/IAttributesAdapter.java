...
public interface IAttributesAdapter {
     ...
     * @return attributes
     */
    Object getAttributesWithLocationsYearList(List<Integer> attributes, List<Integer> locations, List<Integer> yearList);
     ...
     * @return attributes
     */
    Object getAttributesWithLocationsYearRange(List<Integer> attributes, List<Integer> locations, List<Integer> yearRange);
